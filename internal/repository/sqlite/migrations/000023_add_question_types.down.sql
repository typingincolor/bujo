-- Remove 'question', 'answered', and 'answer' from the entry type CHECK constraint
-- Convert any question/answered/answer entries back to task/note first

UPDATE entries SET type = 'task' WHERE type IN ('question', 'answered');
UPDATE entries SET type = 'note' WHERE type = 'answer';
