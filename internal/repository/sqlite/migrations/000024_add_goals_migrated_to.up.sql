-- Add migrated_to column and update status CHECK constraint to include 'migrated'
...
-- Copy existing data
INSERT INTO goals_new (id, entity_id, content, month, status, created_at, version, valid_from, valid_to, op_type)
SELECT id, entity_id, content, month, status, created_at, version, valid_from, valid_to, op_type FROM goals;
