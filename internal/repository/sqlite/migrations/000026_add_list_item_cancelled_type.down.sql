-- Remove 'cancelled' as a valid list item type
-- First convert any cancelled items back to task

PRAGMA foreign_keys=off;

-- Update cancelled items to task
UPDATE list_items SET type = 'task' WHERE type = 'cancelled';
