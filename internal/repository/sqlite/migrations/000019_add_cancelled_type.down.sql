-- Remove 'cancelled' from the entry type CHECK constraint
-- Convert any cancelled entries back to task first

UPDATE entries SET type = 'task' WHERE type = 'cancelled';
