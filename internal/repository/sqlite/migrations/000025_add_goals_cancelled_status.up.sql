...
CREATE TABLE goals_new (
    ...
    month TEXT NOT NULL,
    status TEXT NOT NULL DEFAULT 'active' CHECK (status IN ('active', 'done', 'migrated', 'cancelled')),
    migrated_to TEXT,
...
SELECT id, entity_id, content, month, status, migrated_to, created_at, version, valid_from, valid_to, op_type FROM goals;
