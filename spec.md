                                          ...
                                          - - **`bujo month`**: A monthly grid of events and tasks.
                                            - - **`bujo summary --horizon [day|week|quarter|year]`**: Triggers Gemini reflection.
                                              ...
                                              - 1. **Domain**: Implement Entry and Habit structs with a TreeParser (TDD).
                                                2. 2. **Repository**: Implement SQLite storage with migrations.
                                                   3. 3. **CLI**: Implement cobra or urfave/cli for command handling and os.Stdin support.
                                                      4. 4. **Services**: Integrate Gemini API with a rolling summary logic.
