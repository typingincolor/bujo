...
export function GetAttentionResultType():Promise<domain.AttentionResult>;

export function GetAttentionScores(arg1:Array<number>):Promise<Record<number, domain.AttentionResult>>;
